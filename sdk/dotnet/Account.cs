...
namespace PiersKarsenbarg.Base
{
    ...
    /// Account to define
    /// </summary>
    [BaseResourceType("base:index:Account")]
    public partial class Account : global::Pulumi.CustomResource
    {
        ...
        public Account(string name, AccountArgs? args = null, CustomResourceOptions? options = null)
            : base("base:index:Account", name, args ?? new AccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Account(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("base:index:Account", name, null, MakeResourceOptions(options, id))
        {
        }
